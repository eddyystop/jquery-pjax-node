 ...
 *        e.g. ex2/club?region=r1&club=c1
...
PJAX.controllers['ex2/club'] = function
  ...
  var config = {
    ...
    routes: {
       ...
       * formed from paramsQs e.g. /ex2/screen1?region=r1&club=c1&acct=123
       * 2. The server's handler for route /ex2/screen1 uses the query string,
       ...
       * address line e.g. /ex2/screen1?region=r1&club=c1&acct=123&name=Johnny
       ...
       * frontend handler for /ex2/screen1 is called. It can extract its state
       * info as shown above in the qs and hash properties.
       */
      screen1: {
        path: '/ex2/screen1', container: '',
        paramsQs: ['region', 'club', 'acct']
      },

      /**
       * 1. This route is used on an form tag
       * <form pjax-route="ex2_club_post" method="POST" data-abide="ajax">
  ...
  var regions = PJAX.data['ex2/club'].regions,
    clubs = PJAX.data['ex2/club'].clubs;
...
PJAX.controllers['ex2/team'] = function
...
PJAX.controllers['ex2/schedule'] = function
  (action, options, path, containerId, otherRoute, otherContainer) {
